...
export const secp256k1_sign = (atu8_sk: Uint8Array, atu8_hash: Uint8Array, atu8_ent: Uint8Array) => (secp256k1_wasm()?.sign ?? secp256k1_es_sign)(atu8_sk, atu8_hash, atu8_ent);
