...
import {SI_HASH_ALGORITHM_SHA256, biguint_to_bytes_be, bytes, bytes_to_biguint_be, concat2, crypto_random_bytes, die, hmac, is_bigint} from '@blake.regalia/belt';
...
// export const secp256k1_es_tweak_pk_mul = (atu8_sk: Uint8Array, atu8_tweak: Uint8Array): Uint8Array => biguint_to_bytes_be(mod(normalize_sk(atu8_sk) * bytes_to_biguint_be(atu8_tweak), XG_CURVE_ORDER));
...
export const secp256k1_es_sign = async(atu8_sk: Uint8Array, atu8_hash: Uint8Array, atu8_ent?: Nilable<Uint8Array>): Promise<SignatureAndRecovery> => {
	...
	const atu8_seed = concat2(biguint_to_bytes_be(xg_d), concat2(atu8_h1o, atu8_ent || crypto_random_bytes(32)));
...
export const secp256k1_es_verify = (atu8_signature: Uint8Array, atu8_hash: Uint8Array, atu8_pk: Uint8Array, b_low_s=true): boolean => {
